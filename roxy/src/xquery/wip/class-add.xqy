...
let $class-list := semantics:get-classes-list()
    ...
    <div class="container-narrow">
        <div class="row">
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <form method="post" action="class-save.xqy">
                        <!-- List group -->
                        <ul class="list-group">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel">
                    <!-- Default panel contents -->
                    <div class="panel-heading">Existing classes</div>
                    <p>Classes are...</p>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        {
                        for $class in $class-list/class
                        order by $class/@schema, $class/text()
                        return
                            <tr>
                                <td>{ $class/text() }</td>
                                <td>{ xs:string( $class/@schema ) }</td>
                                <td>
                                    <div>{ xs:string( $class/@value ) }</div>
                                    <small class="text-muted">{ xs:string( $class/@datatype ) }</small>
                                </td>
                            </tr>
                        }
                        </tbody>
