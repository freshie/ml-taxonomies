...
let $nodes :=
    <nodes>
    {
    for $s in xdmp:directory( "http://lds.org/sem/core/", "infinity" )//sem:triple[sem:object = "http://www.w3.org/2004/02/skos/core#Concept"]/sem:subject/text()
...
let $edges :=
    ...
    return
        for $rc in xdmp:directory( "http://lds.org/sem/core/", "infinity" )//sem:triple[
            ...
            sem:predicate = "http://www.w3.org/2004/02/skos/core#related" or
...
return xdmp:document-insert( "http://lds.org/sem/gexf/core.gexf", $file )
